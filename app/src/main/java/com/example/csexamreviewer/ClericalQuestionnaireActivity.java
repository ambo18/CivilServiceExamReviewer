...
public class ClericalQuestionnaireActivity extends AppCompatActivity implements TextToSpeech.OnInitListener {
    ...
    private void initializeViews() {
        ...
        for (int i = 1; i <= 100; i++) {
            ...
            if (textView != null) {
                ...
                Log.e("ClericalQuestionnaireActivity", "TextView with ID questionTextView" + i + " not found.");
            }
            ...
            if (radioGroup != null) {
                ...
                Log.e("ClericalQuestionnaireActivity", "RadioGroup with ID choiceRadioGroup" + i + " not found.");
            }
            ...
            if (textToSpeechButton != null) {
                ...
                Log.e("ClericalQuestionnaireActivity", "ImageView with ID textToSpeechButton" + i + " not found.");
            }
        }
    ...
    private void setOnClickListeners() {
        ...
        for (int i = 0; i < textToSpeechButtons.size(); i++) {
            ...
            if (button != null) {
                ...
                Log.e("ClericalQuestionnaireActivity", "ImageView in textToSpeechButtons list is null at index " + finalI);
            }
        }
    ...
    private void scrollToQuestion(int questionIndexOnPage) {
        ...
        if (questionIndexOnPage < questionTextViews.size()) {
            ...
            Log.e("ClericalQuestionnaireActivity", "Invalid question index for scrolling: " + questionIndexOnPage);
        }
    }                
