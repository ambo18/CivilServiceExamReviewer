...
public class ClericalQuestionnaireActivity extends AppCompatActivity implements TextToSpeech.OnInitListener {
    ...
    private void showScoreDialog() {
        ...
        if (checkAnswer(choiceRadioGroup1, R.id.choiceRadioButton1B)) {
            ...
            correctAnswersText.append("1. Wrong! (Correct Answer: C)\n");
        }
        ...
        if (checkAnswer(choiceRadioGroup2, R.id.choiceRadioButton2D)) {
            ...
            correctAnswersText.append("2. Wrong! (Correct Answer: B)\n");
        }
        ...
        if (checkAnswer(choiceRadioGroup3, R.id.choiceRadioButton3B)) {
            ...
            correctAnswersText.append("3. Wrong! (Correct Answer: A)\n");
        }
        ...
        if (checkAnswer(choiceRadioGroup4, R.id.choiceRadioButton4D)) {
            ...
            correctAnswersText.append("4. Wrong! (Correct Answer: A)\n");
        }
        ...
        if (checkAnswer(choiceRadioGroup5, R.id.choiceRadioButton5D)) {
            ...
            correctAnswersText.append("5. Wrong! (Correct Answer: A)\n");
        }
        ...
        String dialogMessage = "Your score is " + correctAnswers + "/5\n\n";
