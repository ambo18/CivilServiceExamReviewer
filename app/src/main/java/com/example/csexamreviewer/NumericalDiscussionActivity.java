...
public class NumericalDiscussionActivity extends AppCompatActivity implements TextToSpeech.OnInitListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_numerical_discussion);
        ...
        takeQuestionnaireButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(NumericalDiscussionActivity.this, NumericalQuestionnaireActivity.class);
