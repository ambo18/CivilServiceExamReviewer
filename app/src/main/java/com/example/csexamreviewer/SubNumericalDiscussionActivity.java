...
public class SubNumericalDiscussionActivity extends AppCompatActivity implements TextToSpeech.OnInitListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sub_numerical_discussion);
        ...
        takeQuestionnaireButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(SubNumericalDiscussionActivity.this, SubNumericalQuestionnaireActivity.class);
