...
public class AnalyticalDiscussionActivity extends AppCompatActivity implements TextToSpeech.OnInitListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_analytical_discussion);
        ...
        String discussionText = getString(R.string.analytical_discussion_text); // Fetch discussion text from resources
        ...
        takeQuestionnaireButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(AnalyticalDiscussionActivity.this, AnalyticalQuestionnaireActivity.class);
