...
public class VerbalQuestionnaireActivity extends AppCompatActivity implements TextToSpeech.OnInitListener {
    ...
    private void initializeQuestions() {
        ...
        questions.add(new Question("Sentence Ordering:\nArrange the following words to form a coherent sentence:\n'Strategies - innovative - company - the - implemented - to - stay - competitive.'", createChoices("A) The company implemented innovative strategies to stay competitive.", "B) To stay competitive, the company implemented innovative strategies.", "C) Implemented to stay competitive, the company innovative strategies.", "D) Innovative strategies to stay competitive the company implemented."), 0));
        questions.add(new Question("Error Identification:\nIdentify the error in the following sentence:\n'The team is working hard to ensure their project meets it's deadline.'", createChoices("A) their", "B) meets", "C) it's", "D) working"), 2));
        questions.add(new Question("Fill in the blank: \"The successful candidate demonstrated exceptional __________ during the interview.\"", createChoices("prowess", "weakness", "incompetence", "inability"), 0));
        questions.add(new Question("Antonym: Select the word that is the opposite of \"beneficial\":", createChoices("advantageous", "favorable", "detrimental", "profitable"), 2));
        questions.add(new Question("Analogies: \"Teacher is to classroom as conductor is to __________.\"", createChoices("music", "orchestra", "baton", "audience"), 1));
        questions.add(new Question("Sentence Correction: Which of the following sentences is grammatically correct?", createChoices("The team have completed their tasks ahead of schedule.", "Him and his colleagues are attending the seminar.", "She is more talented than any other artist in the gallery.", "Each member of the committee has a specific role to play."), 3));
        questions.add(new Question("Synonyms: Choose the word that is most similar in meaning to \"proficient\":", createChoices("adept", "inept", "mediocre", "amateur"), 0));
        questions.add(new Question("Fill in the blank: \"The negotiation reached a __________ when both parties agreed to the terms.\"", createChoices("stalemate", "compromise", "impasse", "deadlock"), 1));
        questions.add(new Question("Antonym: Select the word that is the opposite of \"obsolete\":", createChoices("current", "modern", "outdated", "ancient"), 0));
        questions.add(new Question("Analogies: \"Chef is to kitchen as conductor is to __________.\"", createChoices("train", "symphony", "music", "orchestra"), 3));
        questions.add(new Question("Sentence Correction: Which of the following sentences is grammatically correct?", createChoices("The company's profits have significantly increased last quarter.", "Each member of the team have different responsibilities.", "Her presentation was more better than his.", "The project manager oversees all aspects of the project."), 3));
        questions.add(new Question("Synonyms: Choose the word that is most similar in meaning to \"precise\":", createChoices("accurate", "vague", "approximate", "uncertain"), 0));
        questions.add(new Question("Fill in the blank: \"The team's collaborative effort led to the __________ completion of the project.\"", createChoices("timely", "delayed", "hasty", "rushed"), 0));
        questions.add(new Question("Antonym: Select the word that is the opposite of \"innovative\":", createChoices("creative", "conventional", "original", "inventive"), 1));
        questions.add(new Question("Analogies: \"Painter is to canvas as writer is to __________.\"", createChoices("pen", "paper", "novel", "ink"), 1));
        questions.add(new Question("Sentence Correction: Which of the following sentences is grammatically correct?", createChoices("The team's efforts have resulted in a successful outcome.", "She is more cleverer than her colleagues.", "Each member of the department are responsible for their tasks.", "The project was completed by she and her team."), 0));
        questions.add(new Question("Synonyms: Choose the word that is most similar in meaning to \"proficient\":", createChoices("adept", "inept", "mediocre", "amateur"), 0));
        questions.add(new Question("Sentence Completion: \"The company's commitment to sustainability is evident in __________ initiatives.\"", createChoices("their", "it's", "there", "its"), 3));
        questions.add(new Question("Word Jumble: Rearrange the letters to form a meaningful word: \"C O R P I T A O N M O M\"", createChoices("Corporation"), 0));
        questions.add(new Question("Reading Comprehension: \"The article highlights the importance of ethical leadership in business. Why is ethical leadership crucial for organizational success?\"", createChoices("To maximize profits", "To maintain employee morale", "To build trust and integrity", "To avoid legal issues"), 2));
        questions.add(new Question("Sentence Ordering: Arrange the following words to form a coherent sentence: \"Innovation - fosters - company - success - and - drives - growth.\"", createChoices("Innovation fosters company success and drives growth.", "Company success and drives growth in innovation fosters.", "Success drives growth in company innovation fosters."), 0));
        questions.add(new Question("Error Identification: Identify the error in the following sentence: \"The committee members were each given their specific tasks.\"", createChoices("committee", "each", "given", "their"), 3));
        questions.add(new Question("Fill in the blank: \"The company's expansion plans were met with __________ from investors.\"", createChoices("enthusiasm", "apathy", "indifference", "disinterest"), 0));
        questions.add(new Question("Antonym: Select the word that is the opposite of \"advantageous\":", createChoices("beneficial", "favorable", "detrimental", "profitable"), 2));
        questions.add(new Question("Analogies: \"Director is to film as author is to __________.\"", createChoices("book", "manuscript", "chapter", "page"), 0));
        questions.add(new Question("Sentence Correction: Which of the following sentences is grammatically correct?", createChoices("The team has been working diligently to achieve their goals.", "Him and his colleagues are attending the conference.", "Each member of the committee have different responsibilities.", "She is more smarter than her peers."), 0));
        questions.add(new Question("Synonyms: Choose the word that is most similar in meaning to \"precise\":", createChoices("accurate", "vague", "approximate", "uncertain"), 0));
        questions.add(new Question("Sentence Completion: \"The negotiation process requires patience, flexibility, and __________ communication skills.\"", createChoices("articulate", "ambiguous", "verbose", "concise"), 0));
        questions.add(new Question("Word Jumble: Rearrange the letters to form a meaningful word: \"O C U M M N I A T I O N\"", createChoices("Communication"), 0));
        questions.add(new Question("Reading Comprehension: \"The stock market experienced a sharp decline due to economic uncertainties. What caused the market downturn?\"", createChoices("Stable economy", "Uncertainties", "Positive outlook", "Government intervention"), 1));
        questions.add(new Question("Sentence Ordering: Arrange the following words to form a coherent sentence: \"Strategies - innovative - company - the - implemented - to - stay - competitive.\"", createChoices("The company implemented innovative strategies to stay competitive.", "To stay competitive, the company implemented innovative strategies.", "Implemented to stay competitive, the company innovative strategies."), 0));
        questions.add(new Question("Error Identification: Identify the error in the following sentence: \"The team is working hard to ensure their project meets it's deadline.\"", createChoices("their", "meets", "it's", "working"), 2));
        questions.add(new Question("Fill in the blank: \"The successful candidate demonstrated exceptional __________ during the interview.\"", createChoices("prowess", "weakness", "incompetence", "inability"), 0));
        questions.add(new Question("Antonym: Select the word that is the opposite of \"beneficial\":", createChoices("advantageous", "favorable", "detrimental", "profitable"), 2));
        questions.add(new Question("Analogies: \"Teacher is to classroom as conductor is to __________.\"", createChoices("music", "orchestra", "baton", "audience"), 1));
        questions.add(new Question("Sentence Correction: Which of the following sentences is grammatically correct?", createChoices("The team have completed their tasks ahead of schedule.", "Him and his colleagues are attending the seminar.", "She is more talented than any other artist in the gallery.", "Each member of the committee has a specific role to play."), 3));
