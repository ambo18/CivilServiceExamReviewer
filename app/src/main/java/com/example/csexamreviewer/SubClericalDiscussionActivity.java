...
public class SubClericalDiscussionActivity extends AppCompatActivity implements TextToSpeech.OnInitListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sub_clerical_discussion);
        ...
        String discussionText = getString(R.string.clerical_discussion_text); // Fetch discussion text from resources
        ...
        takeQuestionnaireButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(SubClericalDiscussionActivity.this, SubClericalQuestionnaireActivity.class);
