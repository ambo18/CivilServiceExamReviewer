...
public class SubGenInfoDiscussionActivity extends AppCompatActivity implements TextToSpeech.OnInitListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sub_gen_info_discussion);
        ...
        takeQuestionnaireButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(SubGenInfoDiscussionActivity.this, SubGenInfoQuestionnaireActivity.class);
